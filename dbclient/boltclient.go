...
import (
	...
	"github.com/sleepypioneer/microservicesInGO/model"
)

// contract we need implementors to fulfill
...
// We bind a function to a struct. Our struct now implicitly implements one of the three methods.
